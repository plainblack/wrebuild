...
wget -t 4 -nv http://surfnet.dl.sourceforge.net/sourceforge/freetype/freetype-2.3.9.tar.bz2
tar jxf freetype-2.3.9.tar.bz2

# gnutls transport layer security http://www.gnu.org/software/gnutls/
wget -t 4 -nv ftp://ftp.gnu.org/pub/gnu/gnutls/gnutls-2.6.6.tar.bz2
...
wget -t 4 -nv http://ftp.yars.free.net/pub/source/lftp/lftp-3.7.14.tar.bz2
tar jxf lftp-3.7.14.tar.bz2
...
wget -t 4 -nv http://voxel.dl.sourceforge.net/sourceforge/lcms/lcms-1.18a.tar.gz
tar zxf lcms-1.18a.tar.gz

# graphviz graph generator http://www.graphviz.org/
wget -t 4 -nv http://www.graphviz.org/pub/graphviz/stable/SOURCES/graphviz-2.22.2.tar.gz
tar xfz graphviz-2.22.2.tar.gz
...
wget -t 4 -nv http://dev.mysql.com/get/Downloads/MySQL-5.0/mysql-5.0.81.tar.gz/from/http://mirror.leaseweb.com/mysql/
