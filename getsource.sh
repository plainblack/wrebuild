...
wget -t 4 -nv ftp://ftp.imagemagick.org/pub/ImageMagick/ImageMagick-6.5.8-8.tar.bz2
tar jxf ImageMagick-6.5.8-8.tar.bz2
...
wget -t 4 -nv http://dev.mysql.com/get/Downloads/MySQL-5.0/mysql-5.0.89.tar.gz/from/http://mirror.leaseweb.com/mysql/
